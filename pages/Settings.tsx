  ...
  return (
    <div className="p-4 space-y-6 pb-24 animate-in fade-in duration-500">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[8px] text-emerald-500/60 font-bold uppercase tracking-widest">Current Version: v1.1.3</p>
              </div>
            </div>
      ...
      <div className="py-6 text-center space-y-1">
        ...
        <p className="text-[8px] font-bold text-slate-400 dark:text-emerald-800/40 uppercase tracking-widest">App Version: 1.1.3</p>
      </div>
